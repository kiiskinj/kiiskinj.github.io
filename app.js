...
class App{
    ...
    setupVR(){
		...
		function onSelectStart1() {
            ...
            this.userData.selectPressed1 = true;
        }

        function onSelectEnd1() {

            this.userData.selectPressed1 = false;
            
        }
		
		function onSqueezeStart1() {
            
            this.userData.squeezePressed1 = true;
        }

        function onSqueezeEnd1() {

            this.userData.squeezePressed1 = false;
        ...
        this.controller1.addEventListener( 'selectstart', onSelectStart1 );
        this.controller1.addEventListener( 'selectend', onSelectEnd1 );
		this.controller1.addEventListener( 'squeezestart', onSqueezeStart1 );
        this.controller1.addEventListener( 'squeezeend', onSqueezeEnd1 );
	...
	handleController1( controller, dt ){
        if (
			controller.userData.selectPressed1 || 
			controller.userData.squeezePressed1  
			){
            const wallLimit = 1.3;
            var speed = 0;
			if(controller.userData.selectPressed1)
			{
				speed += 0.5;
			}
			if(controller.userData.squeezePressed1)
			{
				speed -= 0.5;
			}
            ...
            if (!blocked){
                this.dolly.translateX(-dt*speed);
                pos = this.dolly.getWorldPosition( this.origin );
            }
	...
	render( ) {  
		...
		if (this.controller1 ) this.handleController1( this.controller1, dt );
